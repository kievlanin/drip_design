...
- Map tab: project zone, tiles, layers, drawing modes synced with canvas; trunk trace on a dedicated sub-tab (`map_left_draw_widgets.py` — Drawing / Trunk notebook).
...
- Maximize workspace; collapsible panels; RMB closes contours / ends drafts; snap toggle; hydraulic audit feedback (laterals, emitters, trunk velocity).
